...
// // {
// //     connect(m_statsTimer, &QTimer::timeout, this, &TelemetryBackend::updateStats);
...
// //             m_app->logger->add_sink(std::make_unique<GUISink>(m_logModel));
// //         } else {
...
// //         // Check all three types (CPU, RAM, GPU)
// //         if (context.contains("CPU", Qt::CaseInsensitive)) {
// //             if (qAbs(m_cpuUsage - value) > 0.01) {
// //                 m_cpuUsage = value;
// //                 emit cpuUsageChanged();
// //                 qDebug() << "CPU updated:" << m_cpuUsage;
// //             }
// //         } else if (context.contains("RAM", Qt::CaseInsensitive)) {
// //             if (qAbs(m_ramUsage - value) > 0.01) {
// //                 m_ramUsage = value;
// //                 emit ramUsageChanged();
// //                 qDebug() << "RAM updated:" << m_ramUsage;
// //             }
// //         } else if (context.contains("GPU", Qt::CaseInsensitive)) {
// //             if (qAbs(m_gpuUsage - value) > 0.01) {
// //                 m_gpuUsage = value;
